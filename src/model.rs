//! The headless half of E-OS Slides — everything the GUI shows but nothing that
//! needs a display.
//!
...
//! fixes the shape every eos-slides feature will grow into (identified entries,
...
/// The in-memory document catalogue of E-OS Slides.
///
...
pub const APP_TITLE: &str = "E-OS Slides";
...
pub const SELFTEST_OK: &str = "EOS-SLIDES-SELFTEST-OK";

/// Headless proof that the model works: exercised by `eos-slides --selftest`
